...
#ifndef DNF5_COMMANDS_BOOTC_UPDATED_HPP
#define DNF5_COMMANDS_BOOTC_UPDATED_HPP
...
class BootcUpdateCommand : public Command {
public:
    explicit BootcUpdateCommand(Context & context) : Command(context, "bootcupdate") {}
...
private:
    void parse_bootcupdate_specs(int specs_count, const char * const specs[]);
...
#endif  // DNF5_COMMANDS_BOOTC_UPDATED_HPP
